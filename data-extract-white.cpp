...
int main(int argc, char** argv) {
	...
	err = fopen_s(&file, "C:/Users/TK/flower1227/data/umebachi-0126.txt", "a");
	if(err != 0) printf("結果格納テキストファイルが見つかりません\n");

	//	画像を読み込む
	sprintf_s(buf, 100, "%s%d%s","C:/Users/TK/flower1227/umebachi/umebachi (", i, ").jpg");
	...
	//if(key == 'b'){
		...
		cv_ColorExtraction(img, paraWhite.bit, mask_img, CV_BGR2HSV, 0, 255, 0, 128, 127, 255); //H S Vの順
